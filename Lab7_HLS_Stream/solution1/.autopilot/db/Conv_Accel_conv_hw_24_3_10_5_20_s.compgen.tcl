...
set id 0
set name Conv_Accel_fadd_32ns_32ns_32_5_full_dsp
...
set id 1
set name Conv_Accel_fmul_32ns_32ns_32_4_max_dsp
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename filter \
    op interface \
    ports { filter_address0 { O 10 vector } filter_ce0 { O 1 bit } filter_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename bias \
    op interface \
    ports { bias_address0 { O 4 vector } bias_ce0 { O 1 bit } bias_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename feature_map \
    op interface \
    ports { feature_map_address0 { O 12 vector } feature_map_ce0 { O 1 bit } feature_map_we0 { O 1 bit } feature_map_d0 { O 32 vector } feature_map_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'feature_map'"
}
}
