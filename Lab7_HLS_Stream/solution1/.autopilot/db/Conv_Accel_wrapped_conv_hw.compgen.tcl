...
set ID 6
set MemName Conv_Accel_wrapped_conv_hw_image
...
# Memory (RAM/ROM)  definition:
set ID 7
set MemName Conv_Accel_wrapped_conv_hw_filter
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 750
...
# Memory (RAM/ROM)  definition:
set ID 8
set MemName Conv_Accel_wrapped_conv_hw_bias
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 10
...
# Memory (RAM/ROM)  definition:
set ID 9
set MemName Conv_Accel_wrapped_conv_hw_feature_map
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 4000
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { INPUT_STREAM_TDATA { I 32 vector } INPUT_STREAM_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { INPUT_STREAM_TREADY { O 1 bit } INPUT_STREAM_TDEST { I 5 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { OUTPUT_STREAM_TVALID { O 1 bit } OUTPUT_STREAM_TREADY { I 1 bit } OUTPUT_STREAM_TDEST { O 5 vector } } \
} "
} else {
